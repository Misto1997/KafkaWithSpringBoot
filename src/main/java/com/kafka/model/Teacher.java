...
public class Teacher extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5248775949107613183L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Teacher\",\"namespace\":\"com.kafka.model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"age\",\"type\":[\"null\",\"long\"],\"default\":null}]}");
   ...
   */
  public Teacher(java.lang.Long id, java.lang.CharSequence name, java.lang.Long age) {
    this.id = id;
    this.name = name;
    this.age = age;
  }
   ...
   */
  public static com.kafka.model.Teacher.Builder newBuilder() {
    return new com.kafka.model.Teacher.Builder();
  }
   ...
   * @return A new Teacher RecordBuilder
   */
  public static com.kafka.model.Teacher.Builder newBuilder(com.kafka.model.Teacher.Builder other) {
    return new com.kafka.model.Teacher.Builder(other);
  }
   ...
   * @return A new Teacher RecordBuilder
   */
  public static com.kafka.model.Teacher.Builder newBuilder(com.kafka.model.Teacher other) {
    return new com.kafka.model.Teacher.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Teacher>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.model.Teacher.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.model.Teacher other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder setAge(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.model.Teacher.Builder clearAge() {
      age = null;
